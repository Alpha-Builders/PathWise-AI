  ...
  return (
    <div className="min-h-screen bg-slate-900 p-10">
      <div className="container mx-auto max-w-7xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">
                Skills for <span className="text-green-400">Frontend Developer</span>
              </h1>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="text-center">
                <Trophy className="w-8 h-8 mx-auto text-orange-500 mb-1" />
        ...
        {/* Level Navigation */}
        <div className="mb-8">
          <div className="flex flex-wrap gap-2 p-2 bg-slate-800/80 backdrop-blur-sm rounded-2xl border border-slate-700 shadow-lg">
        ...
        <div className="grid gap-8 ">
          {/* Level Header */}
          <div className={`${currentLevelData.bgColor} rounded-3xl w-[75%] mx-auto p-8 border-2 ${currentLevelData.borderColor}`}>
            ...
            {isCurrentLevelComplete() && nextLevel && (
              <div className="mt-6 p-4 bg-slate-700/70 rounded-xl border border-slate-600">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-green-500 to-green-400 text-white rounded-lg hover:scale-105 transition-all flex items-center gap-2"
                  >
                    Unlock {nextLevel}
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            {currentLevelData.projects.map((project) => (
              <motion.div
                ...
                className="bg-slate-800 rounded-2xl p-6 border border-slate-700 hover:border-green-400 hover:shadow-lg hover:shadow-green-400/10 transition-all duration-300 cursor-pointer group"
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="ml-4 flex-shrink-0">
                    {project.completed ? (
                      ...
                      <div className="w-8 h-8 border-2 border-slate-600 rounded-full group-hover:border-green-400 transition-colors" />
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {project.technologies?.slice(0, 3).map((tech, index) => (
                      <span
                        key={index}
                        className="px-2 py-1 bg-green-500/20 text-green-400 text-xs rounded-md border border-green-500/30"
                      >
                        {tech}
                      </span>
                    ))}
                    {project.technologies?.length > 3 && (
                      <span className="px-2 py-1 bg-slate-700 text-slate-400 text-xs rounded-md border border-slate-600">
